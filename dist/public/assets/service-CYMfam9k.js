import{j as e,e as n}from"./index-C8NtR6fz.js";import{u as s}from"./useQuery-Bsc6N1yf.js";import{c as a}from"./images_(86)_1789546290607-Cizejh77.js";import{z as c}from"./ac25e2a8581a41008a0930d734236922_1789546290888-Tc2fNcA3.js";import{C as o}from"./chevron-left-BKBKeQVD.js";import{C as l}from"./chevron-right-O4BXSwzg.js";const p="/assets/slike-kina-111-1024x576_1789546290852-DoZ2SnMz.jpg";function v(){const{data:r}=s({queryKey:["/api/settings/links"]}),t=[{label:"@Service Telegram",href:r?.supportLink||"https://t.me/sybotx",testId:"button-support-link",size:"short"},{label:`@Groupe Telegram
...
officielle`,href:r?.channelLink||"https://t.me/sybotx",testId:"button-channel-link",size:"tall"}];return e.jsxs("main",{className:"service-reference",children:[e.jsx("style",{children:`
        ...
        .service-reference .service-title { position: absolute; top: 34px; left: 236px; margin: 0; color: #c90018; font-size: 21px; font-weight: 700; line-height: 25px; }
        ...
        .service-reference .telegram-section { box-sizing: border-box; padding: 30px 21px 29px; background: #d9a600; }
        ...
        .service-reference .telegram-link { position: relative; display: grid; width: 100%; align-items: center; justify-items: center; box-sizing: border-box; border: 0; border-radius: 46px; padding: 0 37px 0 10px; background: #fff; color: #b68100; font-size: 21px; font-weight: 400; line-height: 28px; text-align: center; white-space: pre-line; box-shadow: 0 1px 2px rgba(120, 80, 0, .12); transition: transform .12s ease, background-color .12s ease; }
        ...
        .service-reference .telegram-link svg { position: absolute; right: 11px; width: 25px; height: 25px; color: #c90018; stroke-width: 1.9; }
      ...
      `}),e.jsxs("div",{className:"service-screen",children:[e.jsxs("header",{className:"service-header",children:[e.jsx(n,{href:"/account",children:e.jsx("button",{className:"service-back","data-testid":"button-back","aria-label":"Retour",children:e.jsx(o,{"aria-hidden":"true"})})}),e.jsx("img",{className:"service-logo",src:c,alt:"Zijin Mining"}),e.jsx("h1",{className:"service-title",children:"Service client"})]}),e.jsx("section",{className:"benefits","aria-label":"Nos garanties",children:e.jsx("img",{className:"benefit-banner",src:p,alt:"Site Zijin Mining"})}),e.jsxs("section",{className:"telegram-section","aria-labelledby":"telegram-heading",children:[e.jsx("h2",{id:"telegram-heading",className:"telegram-title",children:"Telegram"}),e.jsxs("div",{className:"telegram-grid",children:[e.jsx("img",{className:"bike-image",src:a,alt:"Infrastructures Zijin Mining"}),e.jsxs("div",{className:"telegram-actions",children:[t.map(i=>e.jsxs("button",{type:"button",className:`telegram-link ${i.size}`,onClick:()=>window.open(i.href,"_blank"),"data-testid":i.testId,children:[i.label,e.jsx(l,{"aria-hidden":"true"})]},i.testId)),e.jsxs("div",{className:"online-hours",children:[e.jsx("p",{children:"Horaires en ligne :"}),e.jsx("p",{children:"9:00 AM-7:00 PM"})]})]})]})]}),e.jsxs("section",{className:"advice","aria-label":"Conseils",children:[e.jsx("h2",{className:"advice-title",children:"CONSEILS :"}),e.jsx("p",{className:"advice-copy",children:"1. Pour toute question, n'hésitez pas à contacter notre service client en ligne. Nous serons ravis de vous aider."}),e.jsx("p",{className:"advice-copy",children:"2. Veuillez conserver votre mot de passe en lieu sûr et ne le partagez avec personne."})]})]})]})}export{v as default};
